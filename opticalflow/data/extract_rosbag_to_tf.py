...
def main():
    ...
    # Called from extract_all_bags.sh as:
    #  python extract_rosbag_to_tf.py
    #  --bag $flying_bag_dir${bagnames[$bag_iter]}.bag
    #  --prefix indoor_flying$bag_iter
    #  --start_time ${starttimes[$bag_iter]}
    #  --max_aug $max_aug # = 6
    #  --n_skip 1
    ...
    for topic, msg, t in bag.read_messages(
        ...
        # For "left" and "right"
        # - Read images from bag and same them to file  "left_image<left_image_iter>.png"
        if 'image' in topic:
            width = msg.width
            height = msg.height
